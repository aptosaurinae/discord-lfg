...
def _convert_short_filled_spots_to_full(
    roles: dict[str, RoleDefinition], filled_spots_short: str
) -> dict[str, int]:
    filled_spots_roles = {
        role_name: filled_spots_short.count(role_def.identifier)
        for role_name, role_def in roles.items()
    }
    return filled_spots_roles
